          ...
          <div className="bg-white rounded-2xl shadow-popover p-6 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="bg-warning-50 border border-warning-100 p-3 rounded-lg text-sm text-warning-800">
                  <p>Pour une implémentation complète, utilisez une carte interactive pour définir les coordonnées précises.</p>
                </div>
              </div>
